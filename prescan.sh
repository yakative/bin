...
case $RES in
  ...
  1200)
    ...
    ;;
  *)
      echo "Invalid resolution or none entered (150,200,240,300,400,600,1200)" >&2
      exit 1
      ;;
  esac
...
/usr/bin/epsonscan2 --scan  "EPSON Scanner" template.sf2
